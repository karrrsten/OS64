...
#define EI_PAD        9 /* Start of paddingbytes */
...
#define LFOSABI_SYSV        0 /* System V ABI */
...
#define SHN_UNDEF \
	0 /* Used to mark an undefined or meaningless section reference */
#define SHN_LOPROC 0xFF00 /* Processor-specific use */
#define SHN_HIPROC 0xFF1F
#define SHN_LOOS   0xFF20 /* Environment-specific use */
#define SHN_HIOS   0xFF3F
#define SHN_ABS                                                               \
	0xFFF1 /* Indicates that the corresponding reference is an absolute value \
	        */
#define SHN_COMMON                                                        \
...
#define STB_WEAK \
	2 /* Global scope, but with lower precedence than global symbols */
...
#define DT_NEEDED \
	1 /* d_val, The string table offset of the name of a needed library. */
#define DT_PLTRELSZ                                                        \
	2 /* d_val, Total size, in bytes, of the relocation entries associated \
	     with the procedure linkage table. */
#define DT_PLTGOT                                                          \
	3 /* d_ptr, Contains an address associated with the linkage table. The \
...
#define DT_RELA \
	7 /* d_ptr, Address of a relocation table with Elf64_Rela entries. */
#define DT_RELASZ \
	8 /* d_val, Total size, in bytes, of the DT_RELA relocation table. */
#define DT_RELAENT \
...
#define DT_SONAME \
	14 /* d_val, The string table offset of the name of this shared object. */
#define DT_RPATH                                                         \
	15 /* d_val, The string table offset of a shared library search path \
	      string. */
#define DT_SYMBOLIC                                                         \
	16 /* ignored, The presence of this dynamic table entry modifies the    \
...
#define DT_REL \
	17 /* d_ptr, Address of a relocation table with Elf64_Rel entries. */
#define DT_RELSZ \
	18 /* d_val, Total size, in bytes, of the DT_REL relocation table. */
#define DT_RELENT \
	19 /* d_val, Size, in bytes, of each DT_REL relocation entry. */
#define DT_PLTREL                                                        \
	20 /* d_val, Type of relocation entry used for the procedure linkage \
	      table. The d_val member contains either DT_REL or DT_RELA. */
#define DT_DEBUG 21 /* d_ptr, Reserved for debugger use. */
#define DT_TEXTREL                                                           \
	22 /* ignored, The presence of this dynamic table entry signals that the \
	      relocation table contains relocations for a non-writable segment. */
#define DT_JMPREL                                                         \
	23 /* d_ptr, Address of the relocations associated with the procedure \
	      linkage table. */
#define DT_BIND_NOW                                                            \
	24 /* ignored, The presence of this dynamic table entry signals that the   \
	      dynamic loader should process all relocations for this object before \
	      transferring control to the program. */
#define DT_INIT_ARRAY                                                         \
	25 /* d_ptr, Pointer to an array of pointers to initialization functions. \
	    */
#define DT_FINI_ARRAY \
	26 /* d_ptr, Pointer to an array of pointers to termination functions. */
